      ...
      <form class="film-details__inner" action="" method="get">
        <div class="film-details__top-container">
            ...
            <div class="film-details__info">
              ...
              <table class="film-details__table">
                ...
                <tr class="film-details__row">
                  ...
                  <td class="film-details__cell">${humanizeMovieRuntime(filmInfo.runtime)}</td>
                </tr>
                <tr class="film-details__row">
          ...
          <section class="film-details__controls">
            ...
            <button type="button" class="film-details__control-button ${getControlClassName(userDetails.alreadyWatched)} film-details__control-button--watched" id="watched" name="watched">Already watched</button>
